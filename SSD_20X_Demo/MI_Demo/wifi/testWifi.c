...
static WLAN_HANDLE g_apHdl = AP_HANDLE;
...
void *_ConnectWorkThread(void *args)
{
    ...
    while (1)
    {
        ...
        printf("MI_WLAN_GetStatus: count %d\n", i++);
        ...
        switch (inputChar)
        {
            ...
            case 'n':
                ...
                switch (g_stOpenParam.eNetworkType)
                {
                    ...
                    case E_MI_WLAN_NETWORKTYPE_AP:
                        ...
                        if (MI_SUCCESS == MI_WLAN_Connect(&g_apHdl, &g_stConnectParam[g_selectIdx]))
                            g_bConnected = true;
                        break;
                    default:
                        break;
            ...
            case 'd':
                ...
                if (g_bConnected)
                {
                    ...
                    else if (g_stOpenParam.eNetworkType == E_MI_WLAN_NETWORKTYPE_AP)
                        MI_WLAN_Disconnect(g_apHdl);
            ...
            case 'p':
                ...
                switch (g_stOpenParam.eNetworkType)
                {
                    case E_MI_WLAN_NETWORKTYPE_INFRA:
                        ...
                        break;
                    case E_MI_WLAN_NETWORKTYPE_AP:
                        MI_WLAN_GetStatus(AP_HANDLE, &g_stStatus);
                        if (g_stStatus.stApStatus.u16HostNum > 0)
                        {
                            printf("\n================================================================\n");
                            printf("Access port:\n");
